...
//  liuYao
//
//  Created by Li Shi Wei on 05/12/2016.
...
class SettingTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.tintColor = app.btnColor
    ...
    @IBAction func btnPhoneNumber(_ sender: AnyObject) {
        let str = "15900339338"
        if let url = NSURL(string: "tel://\(str)") {
    ...
    @IBAction func btnEmail(_ sender: AnyObject) {
        let email = "lswlester@hotmail.com"
